...
export const LOGO_URL =
  "https://imgs.search.brave.com/Wde8rJwPypZwciIzgRZNmFMCrIINlNflzoXQC43NBuo/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9pLnBp/bmltZy5jb20vb3Jp/Z2luYWxzLzgzL2M2/L2E5LzgzYzZhOTQy/N2U2YzM2ODU3ZWY2/Y2JjMTBjOWU5NTY1/LmpwZw";
```
...
**On click of "Top Rated Restaurants" Button, Our UI should be filtered, but it is not updating.**
...
**To solve above problem, we use React Hooks.**

## React Hooks

Hooks is a normal JavaScript Function which manages states in React.
...
**Note:**
React is fast because it is faster in dom manipulation.

## Reconciliation Algorithm (React Fiber - React 16)

Suppose, we have 7 restaurant cards. On click of filter button we want 3 filtered cards.

- React creates a virtual dom of 7 cards.

**Real DOM** is a actual tree based structure of tags.
**Virtual DOM** is a representation of an actual DOM. It is in form of an object.

**Diff Algorithm** finds out the difference between the two virtual dom i.e. (7 cards - Older Virtual DOM) and (3 cards - New Virtual DOM) and then re-renders the updated UI.

**Note:**
For Javascript, finding difference out of 2 object is easy and fast instead of actual tags structure.
